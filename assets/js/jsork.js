...
(function() {
    ...
    // var ork = 'https://fog.dev.amtgard.com/orkservice/Json/index.php'
      ...
      kingdoms.then(function(kingdomsArray) {
        ...
        return Promise.all(allParkPromises).then(function(result) {
          ...
          var toReturn = result.reduce(function(acc, val) {
            val.forEach(function(park) {
              if (!abbr[park.Abbreviation]) {
                abbr[park.Abbreviation] = [];
              }
              abbr[park.Abbreviation].push(park.Name);
              // console.log(park.Abbreviation);
            });
    ...
    jsork.kingdom.playerAwards2 = function(kingdomID, minLadder) {
      var promise = new Promise(function(resolve) {
        $.getJSON(ork + '?request=',
          {
            call: 'Report/PlayerAwards',
    ...
    jsork.player.getNotes = function(mundaneID) {
      var promise = new Promise(function(resolve, reject) {
        var request =
            {
              Token: jsork.TOKEN,
    ...
    jsork.player.Underbelts = function(mundaneID) {
      var promise = new Promise(function(resolve, reject) {
        $.getJSON(ork + '?request=',
          {
            call: 'Player/Underbelts',
            request: {
              MundaneId: mundaneID
            }
          },
    ...
    jsork.player.Overbelts = function(mundaneID) {
      var promise = new Promise(function(resolve, reject) {
        $.getJSON(ork + '?request=',
          {
            call: 'Player/Overbelts',
            request: {
              MundaneId: mundaneID
            }
          },
    ...
    jsork.player.updatePlayer = function(mundaneId, userName, givenName, surname, persona, email, waivered, active, duesDate, semesters, parkMemberSince) {
      var promise = new Promise(function(resolve) {
        $.post(
          ork + '?request=Player/UpdatePlayer',
          {
            ...
            request: {
              ...
              ParkMemberSince: parkMemberSince
            }
          },
          function(data) {
            resolve(data);
    ...
    jsork.player.updatePlayerReeve = function(mundaneId, qualified, qualifiedUntil) {
      var promise = new Promise(function(resolve) {
        $.post(
          ork + '?request=Player/UpdatePlayer',
          {
            ...
            request: {
              Token: jsork.TOKEN,
              MundaneId: mundaneId,
              ReeveQualified: qualified ? 1:0,
              ReeveQualifiedUntil: qualifiedUntil,
            }
          },
          function(data) {
            resolve(data);
    ...
    jsork.player.updatePlayerCorpora = function(mundaneId, qualified, qualifiedUntil) {
      var promise = new Promise(function(resolve) {
        $.post(
          ork + '?request=Player/UpdatePlayer',
          {
            ...
            request: {
              Token: jsork.TOKEN,
              MundaneId: mundaneId,
              CorporaQualified: qualified ? 1:0,
              CorporaQualifiedUntil: qualifiedUntil,
            }
          },
          function(data) {
            resolve(data);
    ...
    jsork.awardIDs = {
      ...
      PARAGON_COLOR: 241, PARAGON_REEVE: 242, ORDER_OF_BATTLE: 243, BATTLEMASTER: 244, KNIGHT_OF_BATTLE: 245,
